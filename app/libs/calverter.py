...
"""
Iranian (Jalali) calendar based on calverter.py script from Mehdi Bayazee (Bayazee@Gmail.com)
...
class Calverter:
    ...
    @staticmethod
    def pad(string, howlong, padwith):
    ...
    @staticmethod
    def jalali_to_jd(year, month, day):
